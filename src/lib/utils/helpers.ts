...
/**
 * Converts plain text to HTML-safe format with newlines converted to <br/> tags
 * Text is first escaped, then newlines are converted to <br/> tags
 * @param text - The text to convert
 * @returns HTML-safe text with line breaks
 * @example
 * textToSafeHtml('Line 1\nLine 2')
