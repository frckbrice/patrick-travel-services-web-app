                    ...
                    <div className="flex gap-4">
                        ...
                        <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="SAMPLE">{t('templates.categories.SAMPLE') || 'Samples'}</SelectItem>
                                <SelectItem value="CHECKLIST">{t('templates.categories.CHECKLIST') || 'Checklists'}</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </CardContent>
                ...
                <Card>
                    <CardContent className="py-12 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {t('templates.noTemplatesDescription') || 'Templates will appear here once added by administrators'}
                        </p>
                    </CardContent>
                </Card>
            ) : (
