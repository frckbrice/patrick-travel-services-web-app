...
import { FileText, Search, Shield, Clock, User, AlertCircle, CheckCircle, Info, XCircle } from 'lucide-react';
...
export function AuditLogsList() {
    ...
    // const { data, isLoading } = useAuditLogs({ category: categoryFilter, search: searchQuery });
                                        ...
                                        <div className="flex items-start justify-between gap-2 mb-2">
                                            <div>
                                                <p className="font-medium">
                                                    ...
                                                    {log.entityId && <span className="text-muted-foreground text-sm ml-2">#{log.entityId}</span>}
                                                </p>
