...
const faqs = [
  {
    ...
    answer:
      'Processing times vary by visa type. Student visas typically take 4-6 weeks, while work permits can take 8-12 weeks.',
  },
  {
    question: 'What documents do I need to provide?',
    answer:
      'Required documents depend on your visa type. Check your case dashboard for a personalized checklist.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Navigate to the Documents section and use the upload button. Supported formats: PDF, JPG, PNG, DOC.',
  },
  {
    question: 'What payment methods do you accept?',
    answer:
      'We accept all major credit cards, debit cards, and bank transfers. Payment plans are also available.',
  },
  {
    question: 'Can I get a refund if my visa is rejected?',
    answer:
      'Service fees are non-refundable, but government fees may be refundable depending on the case.',
  },
];
