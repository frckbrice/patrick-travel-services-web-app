...
export function CaseTransferDialog({ caseData, open, onOpenChange, onSuccess }: CaseTransferDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[95vh] overflow-y-auto sm:max-h-[90vh]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Reassign this case to a different immigration agent
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                        ...
                                        <div className="space-y-1 leading-none">
                                            <FormLabel>
                                                Notify client about agent change
                                            </FormLabel>
                                            <FormDescription>
                        ...
                        <DialogFooter>
                            ...
                            >
                                <RefreshCw className={`mr-2 h-4 w-4 ${transferCase.isPending ? 'animate-spin' : ''}`} />
