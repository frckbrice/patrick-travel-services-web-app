                ...
                <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
                            <Badge variant="secondary" className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium shadow-lg border-primary/20">
                                    ...
                                    <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-card/95 to-card/90 backdrop-blur-2xl rounded-3xl p-5 shadow-2xl border-2 border-primary/30 hidden md:block hover:scale-105 transition-transform duration-300">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs font-semibold text-muted-foreground">{t('about.licensedSince')}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 pt-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-muted-foreground">{t('about.mission.licensedDesc')}</div>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-muted-foreground">{t('about.mission.fastDesc')}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value, index) => {
                            ...
                            return (
                                <Card key={index} className="group relative overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                                    <CardHeader className="text-center pb-4">
                                        <div className="relative mb-6">
                                            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${value.gradient} flex items-center justify-center mx-auto shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                                <Icon className="h-8 w-8 text-white" />
                                            </div>
                                            {/* Glow Effect */}
                                            <div className={`absolute inset-0 bg-gradient-to-br ${value.gradient} rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-300 mx-auto w-16 h-16`}></div>
                                        </div>
                                    ...
                                    <div className={`absolute inset-0 bg-gradient-to-br ${value.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-300 pointer-events-none`}></div>
                                </Card>
                            );
                        })}
                    </div>
                ...
                <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {team.map((member, index) => (
                            <Card key={index} className="group text-center border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
