    ...
    <section className="relative w-full min-h-[85vh] md:min-h-[90vh] flex items-center overflow-hidden pt-14 md:pt-16 lg:pt-20">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8 md:space-y-10">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-2 sm:pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 px-2">
            <Button
              size="lg"
          ...
          <div className="pt-8 sm:pt-12 md:pt-16 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-200">
