// GET /api/legal/terms - Get Terms docs (public; active by default)
// POST /api/legal/terms - Create Terms doc (admin only)
...
// GET /api/legal/terms - list Terms (active by default)
...
// POST /api/legal/terms - create Terms (admin only)
const postHandler = asyncHandler(async (request: NextRequest) => {
  ...
  return successResponse({ document: created }, 'Terms document created', 201);
});
