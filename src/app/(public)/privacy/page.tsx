...
export default function PrivacyPage() {
  ...
  return (
    <LegalPageLayout titleKey="legal.privacy.title" lastUpdated="January 20, 2025">
      ...
      >
        ...
        <ul className="list-disc pl-6 mt-2 space-y-2">
          <li>
            <strong>{t('legal.privacy.informationWeCollect.accountInfo').split(':')[0]}:</strong>{' '}
          ...
          <li>
            ...
            {t('legal.privacy.informationWeCollect.immigrationDocs').split(':').slice(1).join(':')}
          </li>
          <li>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">7. {t('legal.privacy.dataRetention.title')}</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">9. {t('legal.privacy.supervisory.title')}</h2>
