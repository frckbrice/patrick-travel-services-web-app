...
export default function StudentVisaPage() {
  ...
  const features = [
    {
      icon: FileText,
      title: t('landing.services.student') || 'Document Preparation',
      description: 'Complete assistance with all required documentation and forms',
    },
    {
      icon: Clock,
      title: 'Fast Processing',
      description: 'Expedited processing to meet your academic deadlines',
    },
    {
      icon: Users,
      title: 'Expert Guidance',
      description: 'Dedicated support throughout your application journey',
    },
    {
      icon: Award,
      title: 'High Success Rate',
      description: 'Proven track record of successful student visa approvals',
    },
  ];
          ...
          >
            <div className="text-center max-w-4xl mx-auto">
              ...
              <Badge className="mb-4" variant="default">
                <span suppressHydrationWarning>{t('landing.services.mostPopular')}</span>
              </Badge>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6">
                <span suppressHydrationWarning>{t('landing.services.student')}</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                <span suppressHydrationWarning>{t('landing.services.studentDesc')}</span>
              </p>
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight mb-4">
                Why Choose Our Student Visa Service?
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => {
                ...
                return (
                  <Card
                    key={`feature-${index}`}
                    className="optimize-rendering border-2 border-blue-200 dark:border-blue-800"
                  >
                    <CardHeader>
        ...
        >
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
                Simple steps to your student visa approval
              </p>
            </div>
            ...
            <Card className="border-2 border-primary/30 optimize-rendering">
              <CardContent className="p-8 sm:p-12 text-center">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Let us help you achieve your educational goals with our expert student visa
                  services.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" asChild>
