...
export default function TermsPage() {
  ...
  return (
    <LegalPageLayout titleKey="legal.terms.title" lastUpdated="January 20, 2025">
      ...
      >
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">{t('legal.terms.fees.refundPolicy')}</h3>
      ...
      <Card className="p-6 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 border-2">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{t('legal.terms.acknowledgment.desc')}</p>
          </div>
        </div>
      </Card>
    </LegalPageLayout>
